...
class mainWindow(object):
	...
	def __init__(self,master):
		...
		self.master.configure(bg='lemon chiffon')  # Background Color dor Window
		appLabel = Tk.Label(self.master, text="Address Book By Anubhav", font=("Times", "22", "bold italic"), fg="red",
						 bg='lemon chiffon')  # Label for Appname
		...
		self.save_button.grid(row=4, column=2, sticky=Tk.W, padx=15,
							  pady=10)
		...
		self.book_list = Tk.Listbox(master, yscrollcommand=self.scrollbar.set,
									height=20, width=36)
		self.book_list.grid(row=4, column=2, rowspan=10, padx=15)
		...
		self.search_bar.grid(row=0, column=4, padx=(0, 300), pady=(1, 0))
		self.search_bar.insert(0, '')

		self.search_return = Tk.Button(master, text='Search',
									   command=self.search_call)
		self.search_return.grid(row=0, column=3, padx=(300, 0), pady=(1, 0))
		...
		self.add_button.grid(row=13, column=2, padx=100)

		# Delete contact button
		self.delete_button = Tk.Button(master, text='Delete',
									   command=self.popup_confirmation)
		self.delete_button.grid(row=14, column=2, padx=100)

		# Edit contact button
		self.edit_button = Tk.Button(master, text='Edit',
									 command=self.popupEdit)
		self.edit_button.grid(row=14, column=4, padx=(0, 350), pady=(50, 0), sticky=Tk.E)

		### The following are text fields to display contact information ###
		# First name
		self.first_name_label = Tk.Label(master, text='First Name:')
		self.first_name_label.grid(row=2, column=3, padx=(300, 0), pady=(20, 0))
		self.first_name = Tk.Entry(master)
		self.first_name.grid(row=2, column=4, padx=(0, 300), pady=(20, 0))

		# Last name
		self.last_name_label = Tk.Label(master, text='Last Name:')
		self.last_name_label.grid(row=3, column=3, padx=(300, 0), pady=(20, 0))
		self.last_name = Tk.Entry(master)
		self.last_name.grid(row=3, column=4, padx=(0, 300), pady=(20, 0))

		# Address 1
		self.address1_label = Tk.Label(master, text='Address 1:')
		self.address1_label.grid(row=4, column=3, padx=(300, 0), pady=(20, 0))
		self.address1 = Tk.Entry(master)
		self.address1.grid(row=4, column=4, padx=(0, 300), pady=(20, 0))

		# Address 2
		self.address2_label = Tk.Label(master, text='Address 2:')
		self.address2_label.grid(row=5, column=3, padx=(300, 0), pady=(20, 0))
		self.address2 = Tk.Entry(master)
		self.address2.grid(row=5, column=4, padx=(0, 300), pady=(20, 0))

		# City
		self.city_label = Tk.Label(master, text='City:')
		self.city_label.grid(row=6, column=3, padx=(300, 0), pady=(20, 0))
		self.city = Tk.Entry(master)
		self.city.grid(row=6, column=4, padx=(0, 300), pady=(20, 0))

		# ST
		self.state_label = Tk.Label(master, text='State:')
		self.state_label.grid(row=7, column=3, padx=(300, 0), pady=(20, 0))
		self.state = Tk.Entry(master)
		self.state.grid(row=7, column=4, padx=(0, 300), pady=(20, 0))

		# Zip
		self.zip_label = Tk.Label(master, text='Zip:')
		self.zip_label.grid(row=8, column=3, padx=(300, 0), pady=(20, 0))
		self.zip = Tk.Entry(master)
		self.zip.grid(row=8, column=4, padx=(0, 300), pady=(20, 0))

		# Home phone
		self.home_label = Tk.Label(master, text='Home:')
		self.home_label.grid(row=9, column=3, padx=(300, 0), pady=(20, 0))
		self.home = Tk.Entry(master)
		self.home.grid(row=9, column=4, padx=(0, 300), pady=(20, 0))

		# Mobile phone
		self.mobile_label = Tk.Label(master, text='Mobile:')
		self.mobile_label.grid(row=10, column=3, padx=(300, 0), pady=(20, 0))
		self.mobile = Tk.Entry(master)
		self.mobile.grid(row=10, column=4, padx=(0, 300), pady=(20, 0))

		# Email
		self.email_label = Tk.Label(master, text='Email:')
		self.email_label.grid(row=11, column=3, padx=(300, 0), pady=(20, 0))
		self.email = Tk.Entry(master)
		self.email.grid(row=11, column=4, padx=(0, 300), pady=(20, 0))

		# Birthday
		self.birthday_label = Tk.Label(master, text='Birthday:')
		self.birthday_label.grid(row=12, column=3, padx=(300, 0), pady=(20, 0))
		self.birthday = Tk.Entry(master)
		self.birthday.grid(row=12, column=4, padx=(0, 300), pady=(20, 0))

		# Notes
		self.notes_label = Tk.Label(master, text="Notes")
		self.notes_label.grid(row=13, column=3, padx=(300, 0), pady=(20, 0))
		self.notes = Tk.Entry(master)
		self.notes.grid(row=13, column=4, padx=(0, 300), pady=(20, 0))
